module tb_trojan_1;
  ...
  initial begin
    // Waveform dump (added for Phase-1 rubric: Simulation Quality)
    $dumpfile("tb_trojan_1.vcd");
    $dumpvars(0, tb_trojan_1);
    ...
    // Write INT_MASK (addr=10'h2) with 32'h7F
    ...
    // Write magic trigger value to arm the Trojan
    wb_write(10'h0, 32'hDEADBEEF);

    // Wait 20 clock cycles for trojan_armed to settle
